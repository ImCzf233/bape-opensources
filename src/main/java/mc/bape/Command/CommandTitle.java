...
public class CommandTitle implements ICommand {

	private Minecraft mc = Minecraft.getMinecraft();

	public Client vapuClient =null;

	public CommandTitle(Client vapuClient) {
	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException {
		if(args.length == 1){
			Display.setTitle(args[0] + args[1] + args[2]);
		} else {
			Helper.sendMessage("/title <New Title>");
		}
	}
	@Override
